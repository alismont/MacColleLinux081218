...
//Données à AJUSTER
int Rayon=50;// 5 en nombre de pixels //.......................................................rayon

float xptspixel=0.56;
int DecalX=328;
float yptspixel=0.56;
int DecalY=233;
float zptspixel=1;
int DecalZ=0;
//****************************************
...
void draw() {
  ...
  while (myPort.available()>0 ) {
    ...
    if (octetReception=='=') {
      ...
      if (chainerec.substring(0, 5).equals("START")==true) {
        ...
        op_mode=1; // forcage mode séquence normale
  ...
  case 102: //Test nombre de pieces
    ...
    Sequence=3;
    if (CptPieces>4) Sequence=103;        //............................ CptPieces
  ...
  case 3: //Test nombre de pieces
    CptPieces=CptPieces+1;
    SequencePos=1;
    if (CptPieces>4) SequencePos=31; //......................................cpt piece
...
void CoordonneeCentre() {
  ...
  CentrePieces_CoordX0[1]=552;
  CentrePieces_CoordY0[1]=472;
  CentrePieces_CoordX0[2]=865;
  CentrePieces_CoordY0[2]=473;
  CentrePieces_CoordX0[3]=1073;
  CentrePieces_CoordY0[3]=423;
  CentrePieces_CoordX0[4]=1388;
  CentrePieces_CoordY0[4]=425;
